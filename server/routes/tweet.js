...
router.post('/text', (req, res) => {
    ...
    if(!username || !body) return res.json(MSG.generateErrorResponse("Missing params", "DATA_MISSING_PARAMS"))
...
router.get("/:tweetid", (req, res) => {
    ...
    if(!id) return res.json(MSG.generateErrorResponse("Missing params", "DATA_MISSING_PARAMS"))
    ...
    if(!tweet) res.json(MSG.generateErrorResponse("Tweet not found", "DATA_NOT_FOUND"))
...
router.post("/media", FileMiddleware.extractUsernamefromJWT, upload.single("file"), (req, res) => {
    ...
    // If params are missing - just throw an error and be on our merry way
    if(!username) return res.json(MSG.generateErrorResponse("Missing params", "DATA_MISSING_PARAMS"))
